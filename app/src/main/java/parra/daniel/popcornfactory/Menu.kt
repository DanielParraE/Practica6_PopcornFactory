...
class Menu : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var seriesAdapter: MovieAdapter = MovieAdapter(this, series)

        gw_movies.adapter = moviesAdapter
        gw_series.adapter = seriesAdapter
